                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Patrak Report </h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">KSS</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Patrak Report</li>
                                </ol>
                            </nav>
                        </div>
                        <!--  <div class="row">
                                            ...
                                            <div class="col-lg-12" id="addnewcontainer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2 mt-3" >
                                                        <label>Product</label>
                                                        <select class="form-control" type="date" id="product">
    ...
    <script>
                                                            ...
                                                            function getreport()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    type: 'GET',
                                                                    url: "dataapi",
                                                                    data: {Action: "patrakreport", product: product, month: month},
                                                                    ...
                                                                    success: function (data) {
                                                                        ...
                                                                        $('.dataTables-example').DataTable({
                                                                            ...
                                                                            buttons: [
                                                                                {extend: 'copy'},
                                                                                {extend: 'csv', title: 'Patrakreport'},
                                                                                {extend: 'excel', title: 'Patrakreport'},
                                                                                {extend: 'pdf', title: 'Patrakreport'},
