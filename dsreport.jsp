                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> DSR Report </h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">KSS</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">DSR Report</li>
                                </ol>
                            </nav>
                        </div>
                        <!--  <div class="row">
    ...
    <script>
                                                            ...
                                                            function getreport()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    type: 'GET',
                                                                    url: "dataapi",
                                                                    data: {Action: "dsrreport", product: product, month: month},
                                                                    ...
                                                                    success: function (data) {
                                                                        ...
                                                                        $('.dataTables-example').DataTable({
                                                                            ...
                                                                            buttons: [
                                                                                {extend: 'copy'},
                                                                                {extend: 'csv', title: 'DSRreport'},
                                                                                {extend: 'excel', title: 'DSRreport'},
                                                                                {extend: 'pdf', title: 'DSRreport'},
