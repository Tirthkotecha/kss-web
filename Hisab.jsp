                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Hisab </h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">KSS</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Hisab</li>
                                </ol>
                            </nav>
                        </div>
                        <!--  <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 mt-3">
                                                        ...
                                                        <select class="form-control" id="status">
                                                            ...
                                                            <option value="Total Matching">Total Matching</option>
    ...
    <script>
                                                            ...
                                                            function MaterialSummaryTbl()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    type: 'GET',
                                                                    url: "dataapi",
                                                                    data: {Action: 'Entrylist', entrydate: entrydate, status: status},
                                                            ...
                                                            function openexistingdetails(entryid, tanktype, entrydate, shift) {
                                                                localStorage.setItem("entryid", entryid);
                                                                localStorage.setItem("tanktype", tanktype);
