                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Density </h3>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="submodaltitle">DENSITY DATA</h5>
                    ...
                    <div class="modal-body" >
                        ...
                        <div class="row" >
                            ...
                            <div class="col-4" >
                                <label >Density @15C</label><label style="color: red;">*</label>
                                <input type="text" class="form-control inputt1"   id="density15" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-6 col-sm-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-6 col-sm-3">
                                        <div class ="form-group">
                                            <button id="deletebtnpart" class="btn btn-danger" onclick="Deletedynamic('tankdensityentry');"  style="width: 95%">Delete</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-xs-6 col-sm-3">
                                        <div class ="form-group">
...
<script>
                                                ...
                                                function openexistingdetails(id, tankname, Productname, tstatus, entrytime, hydrometerreading, temperature, densityat15) {
                                                    ...
                                                    document.getElementById("density15").value = densityat15;
                                                ...
                                                function savepartdetails() {
                                                    ...
                                                    var densityat15 = document.getElementById("density15").value;
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "dataapi",
                                                        data: {Action: "Savedensity", hydrometerreading: hydrometerreading,
                                                            temperature: temperature, densityat15: densityat15, user: user, entryid: entryid},
                                                        success: function (data) {
                                                ...
                                                function getdensity() {
                                                    ...
                                                    $.ajax({
                                                        type: "GET",
                                                        url: "dataapi",
                                                        data: {Action: "getdensityat15", hydrometerreading: hydrometerreading, temperature: temperature},
                                                        success: function (resp) {
                                                            $.unblockUI();
                                                            document.getElementById("densityat15").value = resp;
