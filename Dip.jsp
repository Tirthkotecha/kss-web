...
<html lang="en">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="submodaltitle">DIP DATA</h5>
                        ...
                        <div class="modal-body" >
                            ...
                            <div class="row" >
                                <div class="col-4" >
                                    <label >Tank Dip </label><label style="color: red;">*</label>
                                    <input type="text" class="form-control inputt1"   id="tankdip"  onblur="setstock()" >
                                </div>
                                <div class="col-4" >
                                    <label >Dip Dora</label><label style="color: red;">*</label>
                                    <input type="text" class="form-control inputt1"   id="dipdora"  onblur="setstock()">
                                </div>
                                <div class="col-4" >
                                    <label >Stock</label><label style="color: red;">*</label>
                                    <input type="text" class="form-control inputt1"   id="stock"  readonly="">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-6 col-sm-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-xs-6 col-sm-3">
                                            <div class ="form-group">
                                                <button id="deletebtnpart" class="btn btn-danger" onclick="Deletedynamic('tankdipentry');"  style="width: 95%">Delete</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-xs-6 col-sm-3">
                                            <div class ="form-group">
    ...
    <script>
                                                    ...
                                                    function openexistingdetails(id, tankname, Productname, tstatus, entrytime, tankdip, dipdora, stock) {
                                                        ...
                                                        document.getElementById("tankdip").value = tankdip;
                                                        document.getElementById("dipdora").value = dipdora;
                                                    ...
                                                    function savepartdetails() {
                                                        var dipdora = document.getElementById("dipdora").value;
                                                        var tankdip = document.getElementById("tankdip").value;
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "dataapi",
                                                            data: {Action: "Savedip", dipdora: dipdora,
                                                                tankdip: tankdip, stock: stock, user: user, entryid: entryid},
                                                            success: function (data) {
                                                    ...
                                                    function getchart() {
                                                        ...
                                                        $.ajax({
                                                            type: "GET",
                                                            url: "dataapi",
                                                            data: {Action: "getchart", entryid: entryid},
                                                            success: function (resp) {
                                                                $.unblockUI();
                                                                localStorage.setItem("chart", resp);
                                                    ...
                                                    function getactual() {
                                                        ...
                                                        var chartj = localStorage.getItem("chart");
                                                        var dipdora = document.getElementById("dipdora").value;
                                                        var tankdip = document.getElementById("tankdip").value;
                                                        //var pumpdata = pump.split(" ");
                                                        $.ajax({
                                                            type: "GET",
                                                            url: "mobileservlets",
                                                            data: {Action: "getactualstockfromdip", dipdora: dipdora, tankdip: tankdip, chartj: chartj},
                                                            success: function (resp) {
                                                                $.unblockUI();
                                                                document.getElementById("stock").value = resp;
                                                            },
                                                            error: function (xhr, ajaxOptions, thrownError)
                                                            {
                                                                $.unblockUI();
